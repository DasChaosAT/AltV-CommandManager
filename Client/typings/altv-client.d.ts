...
declare module "natives" {
    ...
    export function getActiveScreenResolution(p0: intPtr, p1: intPtr): void;
    ...
    export function getScreenCoordFromWorldCoord(p0: float, p1: float, p2: float, p3: floatPtr, p4: floatPtr): boolean;
    ...
    export function getStreetNameAtCoord(p0: float, p1: float, p2: float, p3: intPtr, p4: intPtr): void;
